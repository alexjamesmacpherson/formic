...
class SubmissionGradedTest < ActiveSupport::TestCase
  def setup
    ...
    @submission = Submission.new(assignment: @assignment, pupil: @pupil, file: User.new_token, submitted: true, submitted_at: Time.zone.now, marker: @teacher, marked: true, marked_at: Time.zone.now, feedback: 'This is some test feedback.', grade: 50)
  end
