# Thesis Project: Formic Learning (CS310) [![Build Status](https://travis-ci.org/alexjamesmacpherson/formic.svg?branch=master)](https://travis-ci.org/alexjamesmacpherson/formic)
